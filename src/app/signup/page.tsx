    ...
    <div className="fixed inset-0 w-screen h-screen overflow-auto bg-black">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-lg">
          {/* Title */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-10 text-center leading-tight bg-gradient-to-r from-[#617e8b] to-[#fdfdfd] bg-clip-text text-transparent">
            Welcome to AI Agent!
          </h1>
